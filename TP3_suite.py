...
def farm_factory(farm_name, animal_description):
    ...
    for animal in animal_description:
        my_current_farm.add_animal(animal["type"], animal["sex"], animal["birth"])
...
if __name__ == "__main__":
    ...
    with open('C:/Users/cabar/OneDrive/Bureau/EPSI/python/ferme.json') as json_file:
    ...
    for farm in data["farm_list"]:
        
        farm_list.append(farm_factory(farm["Farm"], farm["animals"]))
